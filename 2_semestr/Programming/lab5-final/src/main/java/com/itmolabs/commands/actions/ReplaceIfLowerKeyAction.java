...
public class ReplaceIfLowerKeyAction {

    private CollectionManager collectionManager;

    public ReplaceIfLowerKeyAction(CollectionManager collectionManager) {
    ...
    public String doAction(Integer key, Ticket newTicket) {
        ...
        if (found) {
            return "Element hasn't been updated because it's not lower than given";
        }
